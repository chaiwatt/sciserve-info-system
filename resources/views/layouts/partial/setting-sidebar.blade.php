            ...
            <li class="nav-item {{ request()->is('setting/general*') ? 'menu-open' : '' }}" id="main-sub-menu"> 
                ...
                <ul class="nav nav-treeview" id="sub-menu">
                    <li class="nav-item">
                        ...
                        <a href="{{route('setting.industry-resource')}}"
                    ...
                    <li class="nav-item">
                        ...
                        <a href="{{route('setting.quality-resource')}}"
                            class="nav-link {{ request()->is('setting.general.tax*') ? 'active' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <circle cx="12" cy="12" r="4" fill="#D0D5DD"/>
                            </svg>
                            <p>ข้อมูลทางด้านคุณภาพ</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        ...
                        <a href=""
                            ...
                            <p>ข้อมูลผลิตภัณฑ์ที่เกี่ยวข้อง</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        {{-- <a href="{{route('setting.general.searchfield.index')}}" --}}
                        <a href="{{route('setting.search-filter')}}"
                            class="nav-link ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <circle cx="12" cy="12" r="4" fill="#D0D5DD"/>
                            </svg>
