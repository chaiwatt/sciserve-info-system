            ...
            <div class="title-header">
                ...
                <div aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">กลุ่มการทดสอบ</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-sm-12 " id="table_container">
                                    <div class="table-responsive">
                                        <table class="table table-borderless text-nowrap dataTable dtr-inline">
                                            ...
                                            <tbody>
                                                @foreach ($accreditationCriterias as $accreditationCriteria)
                                                <tr>
                                                    <td>{{$accreditationCriteria->name}}</td>
                                                    <td>
                                                        <ul>
                                                            @foreach ($accreditationCriteria->materialProperties as $materialProperty)
