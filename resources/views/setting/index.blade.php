                ...
                <div class="col-lg-4 col-sm-6 col-12 px-2 mb-3">
                    <div class="d-flex gap-4 p-4 rounded-4" style="background: #F9FAFB">
                        ...
                        <div class="d-flex flex-column justify-content-between">
                            <span>ผู้ใช้ Super Admin</span>
                            <h2 class="m-0">{{$users->where('is_admin',4)->count()}}</h2>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12 px-2 mb-3">
                    <div class="d-flex gap-4 p-4 rounded-4" style="background: #F9FAFB">
                        ...
                        <div class="d-flex flex-column justify-content-between">
                            <span>ผู้ใช้ Admin</span>
                            <h2 class="m-0">{{$users->where('is_admin',3)->count()}}</h2>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12 px-2 mb-3">
                    <div class="d-flex gap-4 p-4 rounded-4" style="background: #F9FAFB">
                        ...
                        <div class="d-flex flex-column justify-content-between">
                            <span>ผู้ใช้ Officer</span>
                            <h2 class="m-0">{{$users->where('is_admin',2)->count()}}</h2>
                        </div>
                    </div>
                </div>
            </div>
